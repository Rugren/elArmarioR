      ...
      <div class="row">
        ...
        <div class="col">
          <div class="mb-3 row">
            ...
            <div class="col-lg-10 col-md-6 col-sm-12">
              <input name="price" value="{{ old('price') }}" type="double" class="form-control" placeholder="Que no se te olvide ponerle un precio">
            </div>
          </div>
        </div>
      </div>
        ...
        <tr>
          ...
          <td>
            <form action="{{ route('admin.product.delete', $product->getId())}}" method="POST">
              {{-- Si hay un comentario en cualquier artículo, no lo borra (hecho esto para no perder los comentarios) --}}
              @csrf
              @method('DELETE')
